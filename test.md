...
5. The backend suite passed 112 tests against PostgreSQL 18.6 on Python 3.14.7 with 87 percent measured coverage. It includes direct authorization, state transition, idempotency, append only history, last capacity, first MRN, and simultaneous queue call tests.
